        ...
        <ul>
          <!-- <li @click="pay_way">
           ...
           <li @click="pay_way">
            ...
            <i>微信支付</i>
            <img src="./no-select.png" v-if="false" class="ispay">
            <img src="./select.png"  class="ispay">
          </li>
        </ul>
      </div>
    </div>
      ...
      query_recipe:function(){
        ...
        if(vm.$route.query.id){
          ...
          this.$http.post('/traditionalChineseMedicine/inquiryBill/queryUserinfoPrescriptionById',{
            ...
            // }
            vm.totalPrice = res.body.data.price

            vm.all_price = res.body.data.price*res.body.data.count 
