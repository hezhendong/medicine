  ...
  methods : {
    ...
    gain_localstorage:function(){
      ...
      if(JSON.parse(localstorage.getItem('medicine')).headImage){
        this.headPath = JSON.parse(localstorage.getItem('medicine')).headImage
      }else{
      ...
      if(JSON.parse(localstorage.getItem('medicine')).sex==1){
        vm.sex_name = '男'
      }else if(JSON.parse(localstorage.getItem('medicine')).sex==2){
        vm.sex_name = '女'
      }else{
        vm.sex_name = ''
      }
