<template>
  <div class="recipe-add" ref='recipe_content'>
    ...
    <div class="recipe-add-content" ref="recipe_add_content">
      <h4>方名</h4>
      ...
      <div class="recipe-detail">
        <i v-for='i in medicion_arr_all'><span>{{i.medicineName}}({{i.type}})</span>&nbsp;&nbsp;&nbsp;&nbsp;{{i.count}}克</i>
      </div>
      ...
      <div class="recipe-img">
        ...
        <label for="upload-recipe-img" v-if="!upload_success"><div><img src="../inquiry/add.png"></div></label>
...
export default {
  ...
  methods : {
    ...
    computed_height_recipe:function(){
      console.log(this.$refs.recipe_content.offsetHeight)

      console.log(this.$refs.recipe_add_content.offsetHeight)
      console.log(this.$refs.top)
      this.$refs.recipe_add_content.style.height =this.$refs.recipe_content.offsetHeight - this.$refs.top.offsetHeight+'px'
    },
    ...mapActions([
        'checkout'
      ]),
    ...
    add_recipe:function(){
      var vm = this
      console.log(vm.$refs)
      if(vm.medicion_arr_all.length&&vm.recipe_name&&vm.pictrue){
        ...
        var mediction_type_json = JSON.parse(vm.json_data)
        console.log(JSON.parse(vm.json_data))
        var mediction_type = ''
        if(mediction_type_json[0].type=='颗粒'){
          mediction_type = 0
        }else{
          mediction_type = 1
        }
        ...
        form.append('medicinalMaterialsType',mediction_type)
