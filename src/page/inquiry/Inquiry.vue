      ...
      <div class="upload-img">
        ...
        <div class="uploadImg">
          <div class="img-box" id="img-box">
              <div class="example">
                <div id="mmm"></div>
                <label for="pic_selector"><div style="width:2rem;height:2rem;border: 1px solid #888;
                  ">
                  <img style="width:1.6rem;height:1.6rem;margin-top:0.15rem;margin-left:0.15rem;" src="./add.png">
                </div></label>
...
export default {
  ...
  methods : {
    ...
    pay_inquiry:function(){
      ...
      formdata.append('payMoney',vm.$route.query.money)
      ...
      new Promise(function(resolve,reject){
        ...
        resolve(formdata)
          ...
          if(res.body.errcode){
            ...
            setTimeout(function(){
              loading.hide();
              vm.$router.push('/payinquiry?id='+vm.$route.query.id+'&inquiryId='+res.body.data.id+'&money='+vm.$route.query.money)
            },1000)
          }
